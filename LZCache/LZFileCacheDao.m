...
#import "LZFileCacheDao.h"

@interface LZFileCacheDao ()
{
...
@implementation LZFileCacheDao

- (NSString*)getCacheDaoFilePath{
    NSString *cacheDir = NSSearchPathForDirectoriesInDomains(NSApplicationSupportDirectory, NSUserDomainMask, TRUE)[0];
